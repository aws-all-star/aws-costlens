...
AWS CostLens는 AWS 클라우드 비용과 주요 비용 발생 서비스를 분석하고, 유휴·미사용 리소스와 잠재적 낭비 요소를 확인하는 가벼운 읽기 전용 CLI 도구입니다. 프로모션 크레딧의 잔액과 만료일을 모니터링하고, EC2·RDS·S3의 태깅 상태를 점검하여 비용 현황과 관리가 필요한 항목을 쉽고 빠르게 확인할 수 있습니다.
<br>
